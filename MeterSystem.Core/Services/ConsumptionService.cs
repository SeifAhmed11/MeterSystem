...
//        public async Task<BaseResponse<ConsumptionDto>> GetByOneAsync(Expression<Func<Consumption, bool>> filter, bool isTracking = false, bool ignoreQueryFilters = false,string? props = null)
//        {
//            try
//            {
//                var entity = await _unitOfWork.Repository<Consumption>().GetOneAsync(filter, isTracking, ignoreQueryFilters ,props);
//                if (entity is null)
